...
class MarkerTester{
    public static void main(String[] args) {
        StudentA john=new StudentA(88, 90, 75);
        StudentB jack=new StudentB(97, 77, 81, 90);
        System.out.println("John's average is "+john.getPercentage());
        System.out.println("Jack's average is "+jack.getPercentage());
